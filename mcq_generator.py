...
from kwargs import DG_1_KWARGS, DG_ALL_KWARGS, PARAPHRASE_KWARGS, QG_KWARGS, QAG_KWARGS
from cosine_similarity import CosineSimilarity
from omegaconf import OmegaConf
from typing import List, Tuple, Mapping

from transformers import T5ForConditionalGeneration, T5Tokenizer, BertForSequenceClassification, BertTokenizer, BertForTokenClassification
...
def parse_argument() -> Namespace:
    ...
    args.add_argument("--dg_path_base", type=str, default="VosLannack/Distractor_all_t5_base")
    ...
    args.add_argument("--dg_1_path_base", type=str, default="VosLannack/Distractor_1_t5_base")
